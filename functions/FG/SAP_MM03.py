...
def Main(material):
    ...
    try:
        ...
        container_type = session.findById("wnd[0]/usr/tabsTABSPR1/tabpSP01/ssubTABFRA1:SAPLMGMM:2004/subSUB1:SAPLMGD1:1002/txtMAKT-MAKTX").Text
        session.findById("wnd[0]/tbar[0]/btn[15]").press()

        response = {"container_type": container_type}
