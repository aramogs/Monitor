...
from functions.SH import SAP_HU03
...
def shipment_delivery(inbound):
    ...
    if len(result_search_delivery) != 0:
        ...
        if error_sap_lx03 != "N/A":
            ...
            response_sap_hu03 = json.loads(SAP_HU03V2.Main(response_sap_lx03["result"]))
...
# print(shipment_delivery({'station': 'a37ef516-e44f-423a-9ea1-7b58936cc6ee', 'serial_num': '', 'delivery': '80692014', 'cantidad': '1482', 'process': 'shipment_delivery', 'material': '', 'embarque': 'BMW2022'}))
